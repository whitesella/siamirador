...
export function doAuthWorkflow(_ref4) {
  var infoJson, windowId, auths, _yield$select, serviceProfiles, nonInteractiveAuthFlowProfiles, authService, profileConfig, tokenService;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          serviceProfiles = _yield$select.auth.serviceProfiles;
